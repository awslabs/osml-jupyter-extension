...
## Project Overview
The OSML Jupyter Extension is a JupyterLab extension designed to work with satellite imagery using OversightML. The project supports interactive visualization and analysis of satellite imagery directly within Jupyter notebooks. It is not expected to meet the full needs of imagery or geospatial analysts. Instead it provides tools for the data science and engineering communities that help build tools for those analysts.
...
- **Key Functionality**: 
  ...
  - Support for geospatial imagery formats including NITF, GeoTIFF, SICD, SIDD, etc.
